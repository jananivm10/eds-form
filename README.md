...
## Environments
- Preview: https://main--eds-form--jananivm10.hlx.page/
- Live: https://main--eds-form--jananivm10.hlx.live/
...
1. Open the `eds-form` directory in your favorite IDE and start coding :)
